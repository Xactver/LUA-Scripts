...
_G.HowMuchRobux = 2500000 -- how much robux u want to dono
...
_G.WhoDonatedID = game:GetService("Players"):GetUserIdFromNameAsync(_G.WhoDonated)
_G.WhoGotRobuxID = game:GetService("Players"):GetUserIdFromNameAsync(_G.WhoGotRobux)
...
function newyearhammer()
game:GetService("StarterGui"):SetCore("ChatMakeSystemMessage", {
            Text = "[GLOBAL]: @".._G.WhoDonated.." just gave "..comma(_G.HowMuchRobux).." ROBUX to @".._G.WhoGotRobux.."!?!?",
            Color = Color3.fromRGB(150,0,128),
            Font = Enum.Font.GothamBold,
            TextSize = 18,
        })
end
function ingamenewyearhammer()
game:GetService("StarterGui"):SetCore("ChatMakeSystemMessage", {
...
elseif NumberWithCommas > 2499999 then
...
local Icon = game:GetObjects("rbxassetid://11991825036")[1]
Icon.Parent = board
...
game:GetService("ReplicatedStorage").Templates.RobuxHammerGiant.Sounds.Rumble.Volume = 1.25
	...
	game:GetService("Workspace").Portal.BrickColor = BrickColor.New()
	...
	print("Animation event: PortalAmbience Sound")
		...
		if game:GetService("Workspace"):FindFirstChild("RobuxHammerGiant") then game:GetService("Workspace").RobuxHammerGiant.DiamondHammer.Handle.Diamonds.BrickColor = BrickColor.new("Mulberry") end
	wait(10.9)
